...
public class GerenteControladorEditar implements Initializable{
	...
	GerenteExistenteException, SQLException {
		try {
			...
			CaixasDeAlerta.CaixaErro("Alterar Gerente", "Campo inv�lido.", ex.getLocalizedMessage());
		}catch(NumberFormatException ex) {
			CaixasDeAlerta.CaixaErro("Alterar Gerente", "Campo inv�lido.", "Preencha os campos corretamente antes de concluir o cadastro.");
		}catch(Exception ex) {
